        ...
        <section className="py-16">
            <div className="relative z-10 mx-auto w-full max-w-2xl px-6 lg:px-0">
                ...
                <div className="relative mt-12 overflow-hidden rounded-3xl bg-black/10 md:mt-16">
                    ...
                    <div className="bg-white opacity-50 rounded-(--radius) relative m-4 overflow-hidden border border-transparent shadow-xl shadow-black/15 ring-1 ring-black/10 sm:m-8 md:m-12 aspect-square">
